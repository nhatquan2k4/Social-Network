...
export class ConversationService {
    ...
    async getUserConversationsForSocketIO(userId: string | Types.ObjectId) {
        try {
            const conversations = await this.conversationRepository.findUserConversationIds(userId);
    ...
    async markAsSeen(conversationId: string, userId: string) {
        ...
        const updated = await this.conversationRepository.updateMarkAsSeen(conversationId, userId);
